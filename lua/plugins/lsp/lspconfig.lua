...
local on_attach = function(client, bufnr)
  ...
  keymap.set("n", "gD", "<Cmd>lua vim.lsp.buf.declaration()<CR>", opts, "[G]oto [D]eclaration")
  ...
  keymap.set("n", "<leader>D", "<cmd>Lspsaga show_line_diagnostics<CR>", opts, "Show Line Diagnostics")
